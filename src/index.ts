...
async function setupViewer() {
    ...
    function setupScrollAnimation() {
        ...
        tl.to(position, {
            ...
            .to('.hero--scroller', {
                opacity: 0, y: '150%',
                scrollTrigger: {
                    trigger: ".cam-view-2", start: "top bottom", end: "top center", scrub: 1, immediateRender: false, pin: '.hero--scroller--container'
                }
            })
            ...
            .to('.hero--container', {
                ...
                scrollTrigger: {
                    trigger: ".cam-view-2", start: "top bottom", end: "top top", scrub: 1, immediateRender: false,
                }
            })
            ...
            .to(position, {
                ...
                scrollTrigger: {
                    trigger: ".cam-view-3", start: "top bottom", end: "top top", scrub: true, immediateRender: false,
                }, onUpdate
            })
            .to(target, {
                x: -0.01, y: 0.9, z: 0.07,
            ...
            .to('.forever--container', {
                ...
                scrollTrigger: {
                    trigger: ".cam-view-3", start: "top bottom", end: 'top top', scrub: 1, immediateRender: false
                }
            })
            .to('.emotions--text-bg', {
                opacity: 0.1, ease: "power4.inOut",
    ...
    async function loadNewModel() {
        if (ringModel == 1) {
            ...
            viewer.scene.removeSceneModels()
            await manager.addFromPath("./assets/awaken.glb")
            gsap.to('.loader', { x: '100%', duration: 0.8, ease: "power4.inOut", delay: 1 })
